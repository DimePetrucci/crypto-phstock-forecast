...
from api.v1.endpoints import auth, health, market, sentiment, intelligence, alerts, watchlist, portfolio, journal
...
router.include_router(journal.router, prefix="/journal/trades", tags=["journal"])
